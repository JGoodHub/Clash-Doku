...
public class MatchController : SceneSingleton<MatchController>
{
    ...
    {
        List<SudokuBoard.ProposedPlacements> botPlacements = BotOpponentController.GetBotPlacements(_board.ProposedChanges, _board, 50, 7);
        EvaluateRoundSequence(_board.ProposedChanges, botPlacements);
    }
